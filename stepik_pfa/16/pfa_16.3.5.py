...
список sorted_numbers был упорядочен по убыванию среднего арифметического элементов кортежей списка numbers.
...
sorted_numbers = sorted(numbers, key=lambda i: sum(i)/len(i), reverse=True)
