...
numbers = [77, 293, 28, 242, 213, 285, 71, 286, 144, 276,
           ...
           5, 161, 46, 159, 23, 169, 23, 172, 184, -7, 228,
           129, 274, 73, 197, 272, 54, 278, 26, 280, 13, 171,
           2, 79, -2, 183, 10, 236, 276, 4, 29, -10, 41, 269,
           94, 279, 129, 39, 92, -63, 263, 219, 57, 18, 236,
           291, 234, 10, 250, 0, 64, 172, 216, 30, 15, 229, 205, 123, -105]

print(sum(map(lambda i: i*i, filter(lambda x: all([0 < abs(x)//10 <= 9, x % 7 == 0]), numbers))))
