...
# print(max(filter(lambda i: isinstance(i, int), mixed_list)))
print(max(mixed_list, key=lambda i: (0, i)[isinstance(i, int)]))
# print(max(mixed_list, key=lambda i: (isinstance(i, int), i)))
